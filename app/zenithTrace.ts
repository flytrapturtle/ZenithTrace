...
export default function ZenithTrace() {
  ...
  return (
    <OnchainKitProvider chain={chain}>
      <div style={{ maxWidth: 860, margin: "46px auto", fontFamily: "system-ui" }}>
        <h1>ZenithTrace — Built for Base</h1>
        ...
        <button onClick={executeTrace} style={{ marginTop: 14 }}>
          Run Trace
        </button>
